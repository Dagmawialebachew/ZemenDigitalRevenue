...
const copy = {
  en: {
    ...
    paymentReady: 'Payment ready for Telegram', paymentGuide: 'Close this page and check the lateset message in your Zemen bot chat. The Mini App will minimize when Telegram opens — that is normal.',
  ...
  am: {
    ...
    paymentReady: 'ክፍያው ለTelegram ተዘጋጅቷል', paymentGuide: 'እባክዎ ከዚ ወጠው ወደ ቴሊግራም ቦት በመሄድ ክፍያዎን ይጨርሱ። Telegram ሲከፈት Mini App መቀነሱ የተለመደ ነው።',
